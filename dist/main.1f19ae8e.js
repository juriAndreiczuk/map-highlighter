...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"mapCanvas/ImageMap.js":[function(require,module,exports) {
"use strict";
...
var ImageMap = /*#__PURE__*/function () {
  ...
  _createClass(ImageMap, [{
    key: "hrefs",
    get: function get() {
      return Array.prototype.map.call(this.areas, function (item) {
        return item.href;
      });
    }
  }, {
    ...
    get: function get() {
      return Array.prototype.map.call(this.areas, function (item) {
        return item.coords.split(',');
      });
    },
    set: function set(val) {
      var _iterator = _createForOfIteratorHelper(this.areas),
          _step;

      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          var area = _step.value;
          area.coords = area.coords.split(',').map(function (item) {
            return item *= val;
          }).join(',');
        }
      } catch (err) {
    ...
    key: "coordsSquare",
    get: function get() {
      return this.coords.map(function (co) {
        return {
          x: co[0],
          y: co[1],
          w: co[2] - co[0],
...
},{}],"mapCanvas/figures/Figure.js":[function(require,module,exports) {
"use strict";
...
var Figure = /*#__PURE__*/function () {
  function Figure(x, y, coords, canvas, hoverColors) {
...
},{}],"mapCanvas/figures/Rect.js":[function(require,module,exports) {
"use strict";
...
var Rect = /*#__PURE__*/function (_Figure) {
  _inherits(Rect, _Figure);
...
},{"./Figure":"mapCanvas/figures/Figure.js"}],"mapCanvas/figures/Poly.js":[function(require,module,exports) {
"use strict";
...
var Poly = /*#__PURE__*/function (_Figure) {
  _inherits(Poly, _Figure);
...
var _Rect = _interopRequireDefault(require("./figures/Rect"));
...
var MapCanvas = /*#__PURE__*/function () {
  function MapCanvas(props) {
    ...
    this.canvas.onmousemove = function (e) {
      return _this.mapHilight(e);
    };

    this.canvas.onclick = function () {
      return location.href = _this.currentLink;
    };
  }
...
var levelsImage = new _MapCanvas.default({
  wrap: '#wrap-canvas',
  canvasId: 'map-canvas',
  mapId: 'image-map',
